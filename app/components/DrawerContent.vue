...
<GridLayout rows="auto, *" class="sidedrawer sidedrawer-left">
            ...
            <ScrollView row="1" class="sidedrawer-content">
                <StackLayout>
                    ...
                    <GridLayout columns="auto, *" :class="'sidedrawer-list-item' + (selectedPage === 'Speech' ? ' selected': '')" @tap="onNavigationItemTap(Speech)">
                        <Label col="0" text.decode="&#xf130;" class="fa"></Label>
                        <Label col="1" text="Speech" class="p-r-10"></Label>
                    </GridLayout>
